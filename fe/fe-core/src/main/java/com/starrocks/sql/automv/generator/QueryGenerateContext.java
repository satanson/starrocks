...
public final class QueryGenerateContext {
    ...
    private QueryGenerateContext(List<Pair<Integer, GenericColumn>> outputColumns, ColumnRefSet inputColumnIds) {
    ...
    public static QueryGenerateContext of(
        ...
        return new QueryGenerateContext(outputColumns, inputColumnIds);
    }
