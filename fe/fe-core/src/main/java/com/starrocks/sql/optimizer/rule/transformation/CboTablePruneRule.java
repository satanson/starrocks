...
import com.starrocks.sql.optimizer.CardinalityPreservingJoinTableGardener;
...
public class CboTablePruneRule extends TransformationRule {
    ...
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        ...
        List<CardinalityPreservingJoinTableGardener.CardinalityPreservingBiRel> lhsToRhsBiRels =
                CardinalityPreservingJoinTableGardener.getCardPreservings(input.inputAt(0), input.inputAt(1), true);

        List<CardinalityPreservingJoinTableGardener.CardinalityPreservingBiRel> rhsToLhsBiRels =
                CardinalityPreservingJoinTableGardener.getCardPreservings(input.inputAt(1), input.inputAt(0), false);

        List<CardinalityPreservingJoinTableGardener.CardinalityPreservingBiRel> biRels = Collections.emptyList();
        ...
        List<CardinalityPreservingJoinTableGardener.CardinalityPreservingBiRel> matchedBiRels =
        ...
        for (CardinalityPreservingJoinTableGardener.CardinalityPreservingBiRel biRel : matchedBiRels) {
