...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_TABLE_PRUNE = "enable_table_prune";
    ...
    @VarAttr(name = ENABLE_TABLE_PRUNE)
    private boolean enableTablePrune = false;
    ...
    public void setEnableTablePrune(boolean enableTablePrune) {
        this.enableTablePrune = enableTablePrune;
    }
    ...
    public boolean isEnableTablePrune() {
        return enableTablePrune;
    }
